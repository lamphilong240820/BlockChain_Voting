					...
					<Form size="large">
						<Segment>
							...
							<Form.Input
								...
								fluid
								placeholder="Nhập mô tả sơ lược về cuộc bầu cử"
							...
							<Message icon info>
								...
								<Message.Header>Ghi chú: </Message.Header>
								<Message.Content>Việc đăng ký sẽ diễn ra trong giây lát. Vui lòng chờ</Message.Content>
							</Message>
						</Segment>
					</Form>
				</Grid.Column>
